...
"A Survey of Automatic Digital Computers", Office of Naval Research, 1953

.Circle Computer characteristics
[caption="Figure ", label=png.jpg]
image::Circle-comp-character.png[height=500,width=550,align="center"]
